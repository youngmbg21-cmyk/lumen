/* =============================================================
   Lumen — Catalogue & Vocabulary
   Public-domain works, honestly labelled. All summaries and
   metadata are original to this project; no copyrighted text
   is reproduced. This file is the single source of truth for
   catalogue content and taxonomy vocabularies.
   ============================================================= */
...
const BOOKS = [
  {
    ...
    heat_level: 4, explicitness: 3, emotional_intensity: 3,
    consent_clarity: 2, taboo_level: 4, plot_weight: 3,
  ...
  },
  {
    ...
    heat_level: 5, explicitness: 5, emotional_intensity: 2,
    consent_clarity: 1, taboo_level: 5, plot_weight: 1,
  ...
  },
  {
    ...
    heat_level: 4, explicitness: 4, emotional_intensity: 3,
    consent_clarity: 2, taboo_level: 5, plot_weight: 2,
  ...
  },
  {
    ...
    heat_level: 4, explicitness: 4, emotional_intensity: 3,
    consent_clarity: 1, taboo_level: 5, plot_weight: 2,
  ...
  },
  {
    ...
    heat_level: 2, explicitness: 3, emotional_intensity: 2,
    consent_clarity: 4, taboo_level: 2, plot_weight: 1,
  ...
  },
  {
    ...
    heat_level: 3, explicitness: 3, emotional_intensity: 2,
    consent_clarity: 3, taboo_level: 2, plot_weight: 1,
  ...
  },
  {
    ...
    heat_level: 2, explicitness: 2, emotional_intensity: 3,
    consent_clarity: 4, taboo_level: 1, plot_weight: 1,
  ...
  },
  {
    ...
    heat_level: 3, explicitness: 3, emotional_intensity: 2,
    consent_clarity: 2, taboo_level: 4, plot_weight: 4,
  ...
  },
  {
    ...
    heat_level: 3, explicitness: 2, emotional_intensity: 3,
    consent_clarity: 3, taboo_level: 3, plot_weight: 5,
  ...
  },
  {
    ...
    heat_level: 2, explicitness: 2, emotional_intensity: 3,
    consent_clarity: 3, taboo_level: 3, plot_weight: 2,
  ...
  },
  {
    ...
    heat_level: 2, explicitness: 1, emotional_intensity: 5,
    consent_clarity: 5, taboo_level: 1, plot_weight: 1,
  ...
  },
  {
    ...
    heat_level: 3, explicitness: 2, emotional_intensity: 5,
    consent_clarity: 4, taboo_level: 4, plot_weight: 4,
  ...
  },
  {
    ...
    heat_level: 4, explicitness: 4, emotional_intensity: 1,
    consent_clarity: 1, taboo_level: 5, plot_weight: 2,
  ...
  },
  {
    ...
    heat_level: 2, explicitness: 2, emotional_intensity: 3,
    consent_clarity: 4, taboo_level: 2, plot_weight: 5,
...
const READING_STATES = [
  { id: "none",       label: "Not tagged",      tone: "neutral" },
  { id: "want",       label: "Want to read",    tone: "accent"  },
  { id: "reading",    label: "Currently reading", tone: "good"  },
  { id: "read",       label: "Already read",    tone: "muted"   },
  { id: "passed",     label: "Not for me",      tone: "danger"  }
];

window.LumenData = { BOOKS, VOCAB, SCENARIOS, DEFAULT_WEIGHTS, DEFAULT_PROFILE, ALL_WARNINGS, READING_STATES };
